...
def modifiy_totalsegmentator(model_folder_set,input: Union[str, Path, Nifti1Image], output: Union[str, Path, None]=None, ml=False, nr_thr_resamp=1, nr_thr_saving=6,
    ...
    from modify_total_nnunet import modifiy_nnUNet_predict_image  # this has to be after setting new env vars
    ...
    if crop is not None or roi_subset is not None:
        ...
        organ_seg, _, _ = modifiy_nnUNet_predict_image(model_folder_set,input, None, crop_model_task, model="3d_fullres", folds=[0],
    ...
    if crop is None and body_seg:
        ...
        body_seg, _, _ = modifiy_nnUNet_predict_image(model_folder_set,input, None, 300, model="3d_fullres", folds=[0],
    ...
    folds = [0]  # None
    seg_img, ct_img, stats = modifiy_nnUNet_predict_image(model_folder_set,input, output, task_id, model=model, folds=folds,
