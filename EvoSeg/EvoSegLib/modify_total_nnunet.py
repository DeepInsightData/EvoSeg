...
def nnUNetv2_predict(model_folder_set, dir_in, dir_out, task_id, model="3d_fullres", folds=None,
...
def modifiy_nnUNet_predict_image(model_folder_set,file_in: Union[str, Path, Nifti1Image], file_out, task_id, model="3d_fullres", folds=None,
        ...
        if multimodel:  # if running multiple models
            ...
            if test == 0:
                ...
                for idx, tid in enumerate(task_id):
                    ...
                    with nostdout(verbose):
                        ...
                        nnUNetv2_predict(model_folder_set,tmp_dir, tmp_dir, tid, model, folds, trainer, tta,
                                         nr_threads_resampling, nr_threads_saving,
            ...
            if test == 0:
                with nostdout(verbose):
                    ...
                    #                nr_threads_resampling, nr_threads_saving)
                    nnUNetv2_predict(model_folder_set,tmp_dir, tmp_dir, task_id, model, folds, trainer, tta,
                                     nr_threads_resampling, nr_threads_saving,
                                     device=device, quiet=quiet, step_size=step_size)
            # elif test == 2:
            #     print("WARNING: Using reference seg instead of prediction for testing.")
