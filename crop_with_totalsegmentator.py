...
def main():
    ...
    if input_path.is_file():
        ...
        success = process_single_file_to_file(input_path, output_path, temp_dir, tuple(args.margin))
        if success:
        ...
        process_directory(input_path, output_path, temp_dir, tuple(args.margin))
